...
/*STUDENT_TEST("DuplicateNegatives, one negative number") {
    Queue<int> q = {-24};
    Queue<int> expected = {-24,-24};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}*/

/*STUDENT_TEST("DuplicateNegatives, postive, negative, positive"){
    Queue<int> q = {13,-24,3};
    Queue<int> expected = {13,-24,-24,3};

    duplicateNegatives(q);
    EXPECT_EQUAL(q, expected);
}*/
STUDENT_TEST("DuplicateNegatives, negative, positive, negative"){
    Queue<int> q = {-13,24,-3};
    Queue<int> expected = {-13,-13,24,-3, -3};
